...
Definition pkat := (pi1 (k ats)).
Definition phi0:= [msg (pk 1); msg (pk 2); msg (pk 5); msg pkat; msg (vt 0); msg (vt 1)].
...
Definition q0 n1 n2 :=  (ifm (eqm (to x1) (V 1)) ((pk 1), (e (b n1 7) 8) , (sign (sk 1) (e (b n1 7) 8) (r 30)))
		    	     (ifm  (eqm (to x1) (V 2))   ((pk 2), (e (b n2 9) 10), (sign (sk 2) (e (b n2 9) 10) (r 31)))
                                   O)).
...
Definition phi1t n1 := phi0 ++ [msg ((pk 1), (e (b n1 7) 8) , (sign (sk 1) (e (b n1 7) 8) (r 30)))]. 
Definition x2t n1 := (f (conv_mylist_listm (phi1t n1))). 
 
Definition phi1ft  n2 := phi0 ++ [msg ((pk 2), (e (b n2 9) 10),  (sign (sk 2) (e (b n2 9) 10) (r 31)))].
...
Definition q1 n1 n2 := (* (ifm (eqm (to (x2t n1)) (V 1))& (bacc pkat (b n1 7) (r 8) (pi1 (x2t n1)))  ok *)
			            (ifm (eqm (to (x2t n1)) (V 2))  ((pk 2), (e (b n2 11) 12),  (sign (sk 2) (e (b n2 11) 12) (r 32))) O).
                                                  
Definition q2 n1 n2 :=  (* (ifm (eqm (to (x2ft n2)) (V 2))& (bacc pkat (b n2 9) (r 10) (pi2 (x2ft n2)))  ok *)
			           (ifm (eqm (to (x2ft n2)) (V 1))  ((pk 1), (e (b n1 13) 14),  (sign (sk 1) (e (b n1 13) 14) (r 33))) O).
...
*)
Definition phi2tt n1 n2 := (phi1t n1) ++ [msg ((pk 2), ( (e (b n2 11) 12),  (sign (sk 2) (e (b n2 11) 12) (r 34))))].
Definition x3tt n1 n2 := (f (conv_mylist_listm (phi2tt n1 n2))). 
(** FT *)
(*
...
*)
Definition phi2ftt n1 n2 := (phi1ft n2) ++ [msg  ((pk 1), ((e (b n1 13) 14), (sign (sk 1) (e (b n1 13) 14) (r 35))))].
Definition x3ftt n1 n2 := (f (conv_mylist_listm (phi2ftt n1 n2))). 
...
Definition q12 n1 n2 := (ifm (eqm (to (x3tft n1 n2)) (V 1))& (bacc pkat (b n1 7) (r 8) (pi1 (x3tft n1 n2))) ok
                                    (ifm (eqm (to (x3tft n1 n2)) (V 2))& (bacc pkat (b n2 11) (r 12) (pi2 (x3tft n1 n2))) ok
                                                  O)).
...
Definition q22 n1 n2 := (ifm (eqm (to (x3ftft n1 n2 )) (V 1))& (bacc pkat (b n1 13) (r 14) (pi1 (x3ftft n1 n2 ))) ok
                                    (ifm (eqm (to (x3ftft n1 n2 )) (V 2))& (bacc pkat (b n2 9) (r 10) (pi2 (x3ftft n1 n2 ))) ok
                                                    O)).
...
Definition q1_s n1 n2 := (ifm (eqm (to (x2t n1)) (V 1))& (bacc pkat (b n1 7) (r 8) (pi1 (x2t n1 )))  (q11 n1 n2)
			           (ifm (eqm (to (x2t n1 )) (V 2))  (q12 n1 n2)
                                                   O)).
 
Definition q2_s n1 n2 :=  (ifm (eqm (to (x2ft  n2)) (V 2))& (bacc pkat (b n2 9) (r 10) (pi2 (x2ft  n2)))  (q21 n1 n2 )
...
(**********************************)
Definition q111 n1 n2 := (ifm  (eqm (to (x4ttt n1 n2)) (V 2))& (bacc pkat (b n2 19) (r 20) (pi2 (x4ttt n1 n2))) ok
                                     O).
...
Definition q121 n1 n2 := (ifm (eqm (to (x4tftt n1 n2)) (V 2 ))& (bacc pkat (b n2 11) (r 12) (pi2 (x4tftt n1 n2))) ok
                         O).

Definition q122 n1 n2 := (ifm (eqm (to (x4tftft n1 n2)) (V 1 ))& (bacc pkat (b n1 7) (r 8) (pi1 (x4tftft n1 n2))) ok
                         O).
 
 
Definition q211 n1 n2 :=  (ifm (eqm (to (x4fttt n1 n2)) (V 1 ))& (bacc pkat (b n1 23) (r 24) (pi1 (x4fttt n1 n2))) ok
                          O).
...
Definition q221 n1 n2:=   (ifm (eqm (to (x4ftftt n1 n2)) (V 2 ))& (bacc pkat (b n2 9) (r 10) (pi2 (x4ftftt n1 n2))) ok
                           O).
Definition q222 n1 n2 :=  (ifm (eqm (to (x4ftftft n1 n2)) (V 1 ))& (bacc pkat (b n1 13) (r 14) (pi1 (x4ftftft n1 n2))) ok O).
...
Definition q12_s n1 n2 := (ifm (eqm (to (x3tft n1 n2)) (V 1))& (bacc pkat (b n1 7) (r 8) (pi1 (x3tft n1 n2))) (q121 n1 n2)
                                    (ifm (eqm (to (x3tft n1 n2)) (V 2))& (bacc pkat (b n2 11) (r 12) (pi2 (x3tft n1 n2))) (q122 n1 n2)
                                                 O)).
...
Definition q22_s n1 n2  := (ifm (eqm (to (x3ftft n1 n2)) (V 1))& (bacc pkat (b n1 13) (r 14) (pi1 (x3ftft n1 n2))) (q221 n1 n2)
                                    (ifm (eqm (to (x3ftft n1 n2)) (V 2))& (bacc pkat (b n2 9) (r 10) (pi2 (x3ftft n1 n2))) (q222 n1 n2)
                                                   O)).
 
(********************************************************************************************)

Definition q1_ss n1 n2 := (ifm (eqm (to (x2t n1 )) (V 1))& (bacc pkat (b n1 7) (r 8) (pi1 (x2t n1 )))  (q11_s n1 n2)
			           (ifm (eqm (to (x2t n1 )) (V 2))  (q12_s n1 n2)
                                                  O)).
 
Definition q2_ss n1 n2 :=  (ifm (eqm (to (x2ft n2)) (V 2))& (bacc pkat (b n2 9) (r 10) (pi2 (x2ft n2)))  (q21_s n1 n2)
...
(** Using [funapptrmhyp] *)
Ltac appconst H:=
  funappmconst ok H; funappmconst (V 1) H; funappmconst (V 2) H; funappmconst (V 3) H; funappmconst O H; funappmconst ONE H; funappmconst TWO H; funappmconst THREE H;  funappbconst FAlse H; try reflexivity.
 Ltac x1checks x1 x2 H := funapptrmhyp (msg x1) (msg x2) H ;
                   ...
                   funapptrmhyp (bol (eqm (to x1) (V 3))) (bol (eqm (to x2) (V 3))) H; try reflexivity.
...
funapptrmhyp (msg (m, (e (b v1 ck) bk))) (msg (m, (e (b v2 ck) bk))) H;
 ...
 funapptrmhyp  (msg (pk a, ((e (b v1 ck) bk), (sign (sk a) (m, (e (b v1 ck) bk))))))  (msg (pk a, ((e (b v2 ck) bk), (sign (sk a) (m, (e (b v2 ck) bk)))))) H; try reflexivity.
   Ltac bacctac v1 v2 ck bk t1 t2 H:=
      funapptrmhyp (msg (pi1 t1)) (msg (pi1 t2)) H; 
     funapptrmhyp (bol (bacc pkat (b v1 ck) (r bk) (pi1 t1))) (bol (bacc pkat (b v2 ck) (r bk) (pi1 t2))) H;
    funapptrmhyp (msg (pi2 t1)) (msg (pi2 t2)) H; 
    funapptrmhyp (bol (bacc pkat (b v1 ck) (r bk) (pi2 t1))) (bol (bacc pkat (b v2 ck) (r bk) (pi2 t2))) H; try reflexivity.
...
Ltac rew_mupbver  :=
  match goal with
    | [|- context[ (ifm (bacc pkat ?M _ ?T) ?T1 ?T2) ] ] => rewrite mupbver with (n := 3) (m:= M)  (t1:= T1) (t2:= T2)
  end. 
 (*Ltac aply_bver := 
  match goal with
