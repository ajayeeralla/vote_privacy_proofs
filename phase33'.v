...
Proof. repeat unfold phi10, phi9, phi8, phi7, phi6, phi5, phi4, phi3, phi2, phi1.
       ...
       apply IFBRANCH_M9 with (ml1:= [msg (pk 1); msg (pk 2); msg (pk 3); msg (nonce 4); 
       ...
       apply IFBRANCH_M8 with (ml1:= [msg (pk 1); msg (pk 2); msg (pk 3); msg (nonce 4); 
                                      msg (pk 5); msg (nonce 6); bol (eqm (to x1) (V 1));
                                      msg (pk 1, (e (b 0 7) 8, sign (sk 1) (ONE, e (b 0 7) 8)));
   ...
   msg
     (shuf (dec (pi1 (pi1 (x76t 1 0))) (sk 5))
       ...
       apply IFBRANCH_M1 with (ml1:= [msg (pk 1); msg (pk 2); msg (pk 3); msg (nonce 4); 
                                      msg (pk 5); msg (nonce 6); bol (eqm (to x1) (V 1));
                                      msg (pk 1, (e (b 0 7) 8, sign (sk 1) (ONE, e (b 0 7) 8)));
                                      bol (eqm (to (x2t 0)) (V 1)) & (bacc (pk 3) (b 0 7) (r 8) (pi1 (x2t 0)));
                                      msg ok; bol (eqm (to (x3tt 0)) (V 2));
